...
**在线演示：** [https://janiestudio.vercel.app/](https://janiestudio.vercel.app/)  
**后台入口：** [https://janiestudio.vercel.app/admin/](https://janiestudio.vercel.app/admin/)
...
3. 修改 .env 中的 DATABASE_URL，把密码部分改为：你的密码
   （例如 mysql://root:你的密码@localhost:3306/janiestudio）
...
1. 注册账号：访问 Aiven 官网，使用你的邮箱或 GitHub 一键注册登录。
...
2. 关联 Vercel：访问 Vercel 官网，选择使用 GitHub 账号一键登录。
